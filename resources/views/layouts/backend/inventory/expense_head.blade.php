        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title"><i class="fas fa-plus"></i> Add Expense Head</h5>
                        </div>
                        <form id="addExpenseHead">
                            @csrf
                            <div class="card-body">
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                <div class="modal-header bg-warning">
                  <h5 class="modal-title" id="exampleModalLabel"><i class="fas fa-edit"></i> Edit Expense Head</h5>
    ...
    $(document).ready(function () {
        $('#addExpenseHead').validate({
           ...
           submitHandler: function(form){
               ...
               $.ajax({
                   url: "{{ route('add.expense.head') }}",
                   method: "POST",
                   data: new FormData(document.getElementById("addExpenseHead")),
